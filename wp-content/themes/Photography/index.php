...
?>
	<div class="blog-header">
		<h1 class="blog-title">Sweet Photography</h1>
	</div>
	<div class="slider">
...
<div class="container">
  <div class="row">
    <div class="col-sm-8 blog-main">
      <div class="homenav">
        <h2>Portrait</h2>
        <a href="<?php echo site_url().'/portrait' ?>"><img src="<?= get_template_directory_uri().'/imgs/portrait7.jpg'; ?>" alt="portrait photography"></a>
      </div>
    </div>
    <div class="col-sm-8 blog-main">
      <div class="homenav">
        <h2>Family/Couples</h2>
        <a href="<?php echo site_url().'/couples-families' ?>"><img src="<?= get_template_directory_uri().'/imgs/couples4.jpg'; ?>"  alt="portrait photography"></a>
      </div>
    </div>    
    <div class="col-sm-8 blog-main">
      <div class="homenav">
        <h2>Wedding</h2>
        <a href="<?php echo site_url().'/wedding' ?>"><img src="<?= get_template_directory_uri().'/imgs/wedding4.jpg'; ?>"  alt="portrait photography"></a>
      </div>
    </div>    
